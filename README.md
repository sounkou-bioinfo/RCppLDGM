...
- initial serial GraphREML-style block likelihood and optimizer:
  `ldgm_reml_link()`, `ldgm_reml_block()`, and `ldgm_run_reml()`;
...
- direct native tree-sequence object wiring for upstream
  ...
  extraction boundary;
- full Python GraphLD graphREML CLI parity, jackknife/score-test
  outputs, surrogate markers, multiprocessing, and SuiteSparse
...
- tinytest: 167 results, all OK with `options(warn = 2)`;
