# RcppLDGM ![RcppLDGM logo](reference/figures/ldgm_logo.png)
...
[`LICENSE.upstream.md`](https://sounkou-bioinfo.github.io/RCppLDGM/LICENSE.upstream.md)
and
[`inst/LICENSE.note`](https://sounkou-bioinfo.github.io/RCppLDGM/inst/LICENSE.note).
...
See the vignettes and
[`docs/rcpp-port-plan.md`](https://sounkou-bioinfo.github.io/RCppLDGM/docs/rcpp-port-plan.md)
/
[`docs/graphld-port-plan.md`](https://sounkou-bioinfo.github.io/RCppLDGM/docs/graphld-port-plan.md)
for deeper design and validation notes.
