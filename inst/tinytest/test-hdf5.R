...
trait_manage_h5 <- tempfile(fileext = ".h5")
ldgm_write_score_test_hdf5(trait_manage_h5, variant_data_h5, gradient_h5, trait_name = "trait_a", overwrite = TRUE)
ldgm_write_score_test_hdf5(trait_manage_h5, variant_data_h5, gradient_h5 + 1, trait_name = "trait_b")
ldgm_write_score_test_hdf5(trait_manage_h5, variant_data_h5, gradient_h5 + 2, trait_name = "trait_c")
ldgm_write_score_test_trait_groups(trait_manage_h5, list(
  keep = c("trait_a", "trait_b", "trait_c"),
  drop = c("trait_b", "trait_c")
))
rename_trait_info <- ldgm_rename_score_test_trait(trait_manage_h5, "trait_c", "trait_gamma")
expect_equal(sort(rename_trait_info$updated_groups), c("drop", "keep"))
expect_true("trait_gamma" %in% ldgm_read_score_test_hdf5(trait_manage_h5)$trait_names)
trait_groups_after_rename <- ldgm_read_score_test_trait_groups(trait_manage_h5)
expect_equal(trait_groups_after_rename$keep, c("trait_a", "trait_b", "trait_gamma"))
expect_equal(trait_groups_after_rename$drop, c("trait_b", "trait_gamma"))
remove_trait_info <- ldgm_remove_score_test_traits(trait_manage_h5, "trait_g*")
expect_equal(remove_trait_info$removed_traits, "trait_gamma")
expect_equal(remove_trait_info$removed_groups, "drop")
expect_equal(ldgm_read_score_test_hdf5(trait_manage_h5)$trait_names, c("trait_a", "trait_b"))
expect_equal(ldgm_read_score_test_trait_groups(trait_manage_h5), list(keep = c("trait_a", "trait_b")))

entry_manage_h5 <- tempfile(fileext = ".h5")
ldgm_write_score_test_hdf5(entry_manage_h5, variant_data_h5, gradient_h5, trait_name = "trait_a", overwrite = TRUE)
ldgm_write_score_test_hdf5(entry_manage_h5, variant_data_h5, gradient_h5 + 1, trait_name = "trait_b")
ldgm_write_score_test_trait_groups(entry_manage_h5, list(pair = c("trait_a", "trait_b")))
rename_entry_group <- ldgm_rename_score_test_hdf5_entry(entry_manage_h5, "pair", "pair_meta")
expect_equal(rename_entry_group$type, "group")
expect_true("pair_meta" %in% names(ldgm_read_score_test_trait_groups(entry_manage_h5)))
rename_entry_trait <- ldgm_rename_score_test_hdf5_entry(entry_manage_h5, "trait_b", "trait_beta")
expect_equal(rename_entry_trait$type, "trait")
expect_equal(rename_entry_trait$updated_groups, "pair_meta")
expect_equal(ldgm_read_score_test_trait_groups(entry_manage_h5)$pair_meta, c("trait_a", "trait_beta"))
remove_entries_info <- ldgm_remove_score_test_hdf5_entries(entry_manage_h5, "trait*")
expect_equal(remove_entries_info$removed_traits, c("trait_a", "trait_beta"))
expect_equal(remove_entries_info$removed_groups, "pair_meta")
expect_equal(ldgm_read_score_test_hdf5(entry_manage_h5)$trait_names, character())
expect_equal(length(ldgm_read_score_test_trait_groups(entry_manage_h5)), 0L)
...
expect_error(ldgm_rename_score_test_trait(trait_manage_h5, "missing_trait", "renamed"), "trait not found")
expect_error(ldgm_rename_score_test_trait(trait_manage_h5, "trait_a", "trait_b"), "trait already exists")
expect_error(ldgm_rename_score_test_trait(trait_manage_h5, "trait_a", "keep"), "existing trait group")
expect_error(ldgm_remove_score_test_traits(trait_manage_h5, "missing*"), "no traits matched")
expect_error(ldgm_rename_score_test_hdf5_entry(trait_manage_h5, "missing", "renamed"), "entry not found")
expect_error(ldgm_remove_score_test_hdf5_entries(trait_manage_h5, "missing*"), "no traits or trait groups matched")
expect_error(ldgm_remove_score_test_hdf5_entries(trait_manage_h5, "missing*", type = "traits"), "no traits matched")
