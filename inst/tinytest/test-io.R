...
expect_equal(variant_info$index, c(1L, 2L, 3L, 2L))
...
expect_equal(ldgm_read_edgelist(edgelist_path), ldgm_edge_list(edge_list$from + 1L, edge_list$to + 1L, edge_list$weight))
