...
Rcpp::List write_graphld_score_hdf5_cpp(const std::string& filename, Rcpp::DataFrame variant_data, Rcpp::NumericVector gradient, SEXP hessian, const std::string& trait_name, Rcpp::IntegerVector jackknife_blocks, bool overwrite, Rcpp::List trait_datasets, const std::string& source, const std::string& compression, int chunk_size, SEXP parameters, SEXP jackknife_parameters);
RcppExport SEXP _RcppLDGM_write_graphld_score_hdf5_cpp(SEXP filenameSEXP, SEXP variant_dataSEXP, SEXP gradientSEXP, SEXP hessianSEXP, SEXP trait_nameSEXP, SEXP jackknife_blocksSEXP, SEXP overwriteSEXP, SEXP trait_datasetsSEXP, SEXP sourceSEXP, SEXP compressionSEXP, SEXP chunk_sizeSEXP, SEXP parametersSEXP, SEXP jackknife_parametersSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< Rcpp::List >::type trait_datasets(trait_datasetsSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(write_graphld_score_hdf5_cpp(filename, variant_data, gradient, hessian, trait_name, jackknife_blocks, overwrite, trait_datasets, source, compression, chunk_size, parameters, jackknife_parameters));
    return rcpp_result_gen;
END_RCPP
}
...
RcppExport SEXP _RcppLDGM_write_graphld_gene_score_hdf5_cpp(SEXP filenameSEXP, SEXP gene_dataSEXP, SEXP gradientSEXP, SEXP hessianSEXP, SEXP trait_nameSEXP, SEXP jackknife_blocksSEXP, SEXP overwriteSEXP, SEXP trait_datasetsSEXP, SEXP sourceSEXP, SEXP compressionSEXP, SEXP chunk_sizeSEXP, SEXP parametersSEXP, SEXP jackknife_parametersSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::string& >::type filename(filenameSEXP);
    ...
    Rcpp::traits::input_parameter< SEXP >::type parameters(parametersSEXP);
    Rcpp::traits::input_parameter< SEXP >::type jackknife_parameters(jackknife_parametersSEXP);
    rcpp_result_gen = Rcpp::wrap(write_graphld_gene_score_hdf5_cpp(filename, gene_data, gradient, hessian, trait_name, jackknife_blocks, overwrite, trait_datasets, source, compression, chunk_size, parameters, jackknife_parameters));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_RcppLDGM_write_graphld_score_hdf5_cpp", (DL_FUNC) &_RcppLDGM_write_graphld_score_hdf5_cpp, 13},
    {"_RcppLDGM_write_graphld_gene_score_hdf5_cpp", (DL_FUNC) &_RcppLDGM_write_graphld_gene_score_hdf5_cpp, 13},
