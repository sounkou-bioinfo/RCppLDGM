...
actual_parameters <- ldgm_reml_results(fit, format = "wide", name = "trait", metric = "parameters")
actual_heritability <- ldgm_reml_results(fit, format = "wide", name = "trait", metric = "heritability")
actual_enrichment <- ldgm_reml_results(fit, format = "wide", name = "trait", metric = "enrichment")
